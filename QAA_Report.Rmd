...
R1 is more consistant in quality score for both data sets. As expected, read quality dips at the beginning and ands of the reads. Overall, all reads average over 30 in phred+33 encoding.
...
grid.arrange(rasterGrob(S9R1), rasterGrob(S9R2), nrow = 1, ncol = 2,
...
grid.arrange( rasterGrob(S21R1), rasterGrob(S21R2), nrow = 1, ncol = 2,
